...
<div class="formulaire">
    <form action="index.php?action=ajout_article" method="post">
        <div class="group-1">
            ...
            <input type="text" id="prix_commande" name="prix_commande" placeholder="prix commande" required></br>
        ...
        <label for="text">Prix magasin</label></br>
            <input type="text" id="prix_magasin" name="prix_magasin" placeholder="prix magasin" required></br>
            <label for="text">Prix vip</label></br>
            <input type="text" id="prix_vip" name="prix_vip" placeholder="prix vip" required></br>
            <label for="quantite">Quantite</label></br>
            <input type="int" id="quantite_produit" name="quantite_produit" placeholder="quantite" required></br>
        </div>
